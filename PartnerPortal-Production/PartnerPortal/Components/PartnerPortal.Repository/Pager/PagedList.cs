...
namespace System.Web.Mvc
{
    ...
    {
        public PagedList(IList<T> items, int pageIndex, int pageSize, int totalPageCount)
        {
            PageSize = pageSize;
        ...
        public PagedList(IEnumerable<T> items, int pageIndex, int pageSize, int totalItemCount, bool isBase = false)
        {
            AddRange(items);
