(function(i, g, c, h, e, k, f) { /*! Jssor */
    new (function() {});
    var d = i.$Jease$ = {
        $Swing: function(a) { return -c.cos(a * c.PI) / 2 + .5 }, $Linear: function(a) { return a }, $InQuad: function(a) { return a * a }, $OutQuad: function(a) { return -a * (a - 2) }, $InOutQuad: function(a) { return (a *= 2) < 1 ? 1 / 2 * a * a : -1 / 2 * (--a * (a - 2) - 1) }, $InCubic: function(a) { return a * a * a }, $OutCubic: function(a) { return (a -= 1) * a * a + 1 }, $InOutCubic: function(a) { return (a *= 2) < 1 ? 1 / 2 * a * a * a : 1 / 2 * ((a -= 2) * a * a + 2) }, $InQuart: function(a) { return a * a * a * a }, $OutQuart: function(a) { return -((a -= 1) * a * a * a - 1) }, $InOutQuart: function(a) { return (a *= 2) < 1 ? 1 / 2 * a * a * a * a : -1 / 2 * ((a -= 2) * a * a * a - 2) }, $InQuint: function(a) { return a * a * a * a * a }, $OutQuint: function(a) { return (a -= 1) * a * a * a * a + 1 }, $InOutQuint: function(a) { return (a *= 2) < 1 ? 1 / 2 * a * a * a * a * a : 1 / 2 * ((a -= 2) * a * a * a * a + 2) }, $InSine: function(a) { return 1 - c.cos(c.PI / 2 * a) }, $OutSine: function(a) { return c.sin(c.PI / 2 * a) }, $InOutSine: function(a) { return -1 / 2 * (c.cos(c.PI * a) - 1) }, $InExpo: function(a) { return a == 0 ? 0 : c.pow(2, 10 * (a - 1)) }, $OutExpo: function(a) { return a == 1 ? 1 : -c.pow(2, -10 * a) + 1 }, $InOutExpo: function(a) { return a == 0 || a == 1 ? a : (a *= 2) < 1 ? 1 / 2 * c.pow(2, 10 * (a - 1)) : 1 / 2 * (-c.pow(2, -10 * --a) + 2) }, $InCirc: function(a) { return -(c.sqrt(1 - a * a) - 1) }, $OutCirc: function(a) { return c.sqrt(1 - (a -= 1) * a) }, $InOutCirc: function(a) { return (a *= 2) < 1 ? -1 / 2 * (c.sqrt(1 - a * a) - 1) : 1 / 2 * (c.sqrt(1 - (a -= 2) * a) + 1) },
        ...
        $InBounce: function(a) { return 1 - d.$OutBounce(1 - a) },
        ...
        $InOutBounce: function(a) { return a < 1 / 2 ? d.$InBounce(a * 2) * .5 : d.$OutBounce(a * 2 - 1) * .5 + .5 },
    ...
    var b = i.$Jssor$ = new function() {
        ...
        function Gb() {
            if (!L) {
                L = { gf: "ontouchstart" in i || "createTouch" in g };
                var a;
        ...
        function hb() { return r() && (l < 6 || g.compatMode == "BackCompat") }

        function zb() { return v(ib) }

        function jb() { return v(lb) }

        function Cb() { return v(kb) }

        function nb() { return v(ob) }

        function db() { return jb() && B > 534 && B < 535 }
        ...
        var pb = {};
        n(["Boolean", "Number", "String", "Function", "Array", "Date", "RegExp", "Object"], function(a) { pb["[object " + a + "]"] = a.toLowerCase() });
        ...
        function G(a) { return a == h ? String(a) : pb[sb(a)] || "object" }

        function qb(a) { for (var b in a) return e }
        ...
        function wb(b, a) { setTimeout(b, a || 0) }
        ...
        function R(b, a) { if (l < 9) b.style.filter = a }
        ...
        j.fc = fb;
        eb("transform");
        j.$BrowserVersion = function() { return l };
        j.$BrowserEngineVersion = function() { return t || l };
        ...
        function Y(a) { a.constructor === Y.caller && a.ue && a.ue.apply(a, Y.caller.arguments) }
        ...
        function O(d, a) {
            ...
            if (a) {
                ...
                if (H()) {
                    if (a.$TranslateX || a.$TranslateY || a.$TranslateZ != f) c += " translate3d(" + (a.$TranslateX - 0.7 || 0) + "px," + (a.$TranslateY || 0) + "px," + (a.$TranslateZ || 0) + "px)";
        ...
        j.$ClearInnerHtml = function(a) { a.innerHTML = "" };
        ...
        j.ig = gb;
        j.Yf = function(b, a) { return b.getElementsByTagName(a) };
        ...
        j.wd = function(a) { return G(a) == "function" };
        j.lf = function(a) { return G(a) == "string" };
        j.Xb = function(a) { return !isNaN(q(a)) && isFinite(a) };
        j.$Each = n;
        j.hd = C;
        ...
        j.$CreateElement = S;
        j.$CreateDiv = function() { return S("DIV") };
        j.Qf = function() { return S("SPAN") };
        j.Cd = function() {};
        ...
        function V(a, b) { return W(a, b) || W(a, "data-" + b) }
        ...
        function xb(b, a) { return b.match(a || yb) }

        function Q(b, a) { return vb(xb(b || "", a)) }
        ...
        function J(a, c, b) { y(a, bb(" ", F(Z(Q(y(a)), Q(c)), Q(b)))) }

        j.re = function(a) { return a.parentNode };
        j.V = function(a) { j.ib(a, "none") };
        j.A = function(a, b) { j.ib(a, b ? "none" : "") };
        j.Rf = function(b, a) { b.removeAttribute(a) };
        j.Xf = function() { return r() && l < 10 };
        j.Vf = function(d, a) {
        ...
        j.P = function() { return +new Date };
        j.$AppendChild = function(b, a) { b.appendChild(a) };
        j.bc = function(b, a, c) { (c || a.parentNode).insertBefore(b, a) };
        j.Kb = function(b, a) {
            a = a || b.parentNode;
            a && a.removeChild(b)
        };
        j.Jf = function(a, b) { n(a, function(a) { j.Kb(a, b) }) };
        j.xc = function(a) { j.Jf(j.$Children(a, e), a) };
        j.Kf = function(a, b) {
            var c = j.re(a);
            b & 1 && j.B(a, (j.$CssWidth(c) - j.$CssWidth(a)) / 2);
            b & 2 && j.C(a, (j.$CssHeight(c) - j.$CssHeight(a)) / 2)
        };
        j.Rb = function(b, a) { return parseInt(b, a || 10) };
        j.De = q;
        j.dg = function(b, a) {
            var c = g.body;
            while (a && b !== a && c !== a)
        ...
        j.Mb = function(a) { return new Eb(a) };
        j.$Css = w;
        j.mb = m("overflow");
        j.C = m("top", 2);
        j.B = m("left", 2);
        ...
        var U = { $Opacity: j.Db, $Top: j.C, $Left: j.B, S: j.$CssWidth, R: j.$CssHeight, Bb: j.z, Mh: j.ib, $ZIndex: j.D };

        function x(g, l) {
            var e = fb(), b = H(), d = db(), i = M(g);

            function k(b, d, a) {
                var e = b.ub(p(-d / 2, -a / 2)), f = b.ub(p(d / 2, -a / 2)), g = b.ub(p(d / 2, a / 2)), h = b.ub(p(-d / 2, a / 2));
                b.ub(p(300, 300));
            ...
            function a(d, a) {
                a = a || {};
                var n = a.$TranslateZ || 0, p = (a.$RotateX || 0) % 360, q = (a.$RotateY || 0) % 360, u = (a.$Rotate || 0) % 360, l = a.$ScaleX, m = a.$ScaleY, g = a.Kh;
                if (l == f) l = 1;
                if (m == f) m = 1;
                if (g == f) g = 1;
                if (e) {
        ...
        function Ab(j, k, o) {
            ...
            function e(c, a) { return m.apply(h, (a || b).concat(c)) }
            ...
            d.Pe = function() { return "matrix3d(" + b.join(",") + ")" };
            d.ze = function() { return "progid:DXImageTransform.Microsoft.Matrix(M11=" + b[0] + ", M12=" + b[4] + ", M21=" + b[1] + ", M22=" + b[5] + ", SizingMethod='auto expand')" }
        }
        ...
        new (function() {
            ...
            a.$ScaleX = function(b, c) { return a.Ld(b, c, 0) };
            a.$ScaleY = function(b, c) { return a.Ld(b, 0, c) };
            a.Ld = function(a, c, d) { return b(a, [[c, 0], [0, d]]) };
            a.ub = function(d, c) {
                var a = b(d, [[c.x], [c.y]]);
                return p(a[0][0], a[1][0])
            }
        });
        var P = { he: 0, ve: 0, L: 0, J: 0, $Zoom: 1, $ScaleX: 1, $ScaleY: 1, $Rotate: 0, $RotateX: 0, $RotateY: 0, $TranslateX: 0, $TranslateY: 0, $TranslateZ: 0, $SkewX: 0, $SkewY: 0 };
        j.uc = function(c, d) {
            var a = c || {};
            if (c)
                if (b.wd(c)) a = { bb: a };
                else if (b.wd(c.$Clip)) a.$Clip = { bb: c.$Clip };
            a.bb = a.bb || d;
        ...
        j.fe = function(l, m, x, q, z, A, n) {
            ...
            if (l) {
                a = {};
                for (var i in m) {
                    var B = A[i] || 1, w = z[i] || [0, 1], g = (x - w[0]) / w[1];
                    g = c.min(c.max(g, 0), 1);
                    g = g * B;
                    var u = c.floor(g);
                    if (g != u) g -= u;
                    var j = q.bb || d.$Linear, k, C = l[i], p = m[i];
                    if (b.Xb(p)) {
                        j = q[i] || j;
                        var y = j(g);
                        k = C + p * y
                ...
                var t = b.$Each(m, function(b, a) { return P[a] != f });
                t && b.$Each(P, function(c, b) { if (a[b] == f && l[b] !== f) a[b] = l[b] });
                if (t) {
            ...
            if (m.$Clip && n.$Move) {
                var o = a.$Clip.Sb, s = (o.$Top || 0) + (o.$Bottom || 0), r = (o.$Left || 0) + (o.$Right || 0);
                a.$Left = (a.$Left || 0) + r;
                a.$Top = (a.$Top || 0) + s;
                a.$Clip.$Left -= r;
                a.$Clip.$Right -= r;
    ...
    function m() {
        ...
        function h(a, b) { d.push({ Fc: a, Ic: b }) }

        function g(a, c) { b.$Each(d, function(b, e) { b.Fc == a && b.Ic === c && d.splice(e, 1) }) }

        a.$On = a.addEventListener = h;
        a.$Off = a.removeEventListener = g;
        a.l = function(a) {
            var c = [].slice.call(arguments, 1);
            b.$Each(d, function(b) { b.Fc == a && b.Ic.apply(i, c) })
        }
    }

    var l = function(z, D, g, M, P, K) {
        z = z || 0;
        var a = this, q, o, p, v, A = 0, I, J, H, B, y = 0, j = 0, m = 0, E, l, f, d, n, C, w = [], x;
        ...
        function u(p) {
            var h = p;
            if (n) if (!C && (h >= d || h < f) || C && h >= n) h = ((h - f) % n + n) % n + f;
            if (!E || v || j != h) {
                var i = c.min(h, d);
                i = c.max(i, f);
                if (!E || v || i != m) {
                    if (K) {
                        ...
                        if (x) b.$Each(o, function(b, a) { x[a] && x[a](M, b) });
                        else b.N(M, o)
                    }
                    a.Nc(m - l, i - l);
                    var r = m, q = m = i;
        ...
        function L() {
            if (q) {
                var d = b.P(), e = c.min(d - A, g.le), a = j + e * p;
                A = d;
                if (a * p >= o * p) a = o;
                u(a);
                if (!v && a * p >= o * p) N(B);
        ...
        a.$Play = function(a, b, c) { t(a ? j + a : d, b, c) };
        a.te = t;
        a.pb = N;
        a.Ge = function(a) { t(a) };
        a.Y = function() { return j };
        a.Nd = function() { return o };
        a.yb = function() { return m };
        a.H = u;
        a.$Move = function(a) { u(j + a) };
        a.$IsPlaying = function() { return q };
        a.Ie = function(a) { n = a };
        a.$Shift = Q;
        a.O = function(a, b) { F(a, 0, b) };
        a.Ec = function(a) { F(a, 1) };
        a.je = function(a) { d += a };
        a.Nb = function() { return f };
        a.tb = function() { return d };
        a.Pb = a.oe = a.ie = a.Nc = b.Cd;
        a.yc = b.P();
        g = b.p({ $Interval: 16, le: 50 }, g);
        n = g.Ac;
        C = g.Oe;
        x = g.Qe;
        f = l = z;
    ...
    var o = i.$JssorSlideshowFormations$ = new function() {
        ...
        h.$FormationSwirl = function(q) {
            var x = q.$Cols, y = q.$Rows, B = q.$Assembly, w = q.lc, A = [], z = [], u = 0, c = 0, h = 0, r = x - 1, s = y - 1, t, p, v = 0;
            switch (B) {
            case j:
                c = r;
                h = 0;
        ...
        h.$FormationZigZag = function(p) {
            var w = p.$Cols, x = p.$Rows, z = p.$Assembly, v = p.lc, t = [], u = 0, c = 0, e = 0, q = w - 1, r = x - 1, y, h, s = 0;
            switch (z) {
            case j:
                c = q;
                e = 0;
        ...
        h.$FormationStraightStairs = function(q) {
            var u = q.$Cols, v = q.$Rows, e = q.$Assembly, t = q.lc, r = [], s = 0, c = 0, d = 0, f = u - 1, h = v - 1, x = t - 1;
            switch (e) {
            case j:
            case m:
            case o:
    ...
    i.$JssorSlideshowRunner$ = function(n, s, q, u, z) {
        ...
        function t(a) {
            ...
            b.$Each(a, function(a) { b.hd(a) && t(a) })
        }

        function j(g, f) {
            var a = { $Interval: f, $Duration: 1, $Delay: 0, $Cols: 1, $Rows: 1, $Opacity: 0, $Zoom: 0, $Clip: 0, $Move: k, $SlideOut: k, $Reverse: k, $Formation: o.$FormationRandom, $Assembly: 1032, $ChessMode: { $Column: 0, $Row: 0 }, $Easing: d.$Swing, $Round: {}, nc: [], $During: {} };
            b.p(a, g);
            t(a);
            a.lc = a.$Cols * a.$Rows;
            ...
            a.We = function(c, b) {
                ...
                if (!a.nc[f]) {
                    a.nc[f] = { S: c, R: b };
                    for (var d = 0; d < a.$Cols; d++) for (var e = 0; e < a.$Rows; e++) a.nc[f][e + "," + d] = { $Top: e * b, $Right: d * c + c, $Bottom: e * b + b, $Left: d * c }
                }
                return a.nc[f]
            };
            if (a.$Brother) {
        ...
        function p(B, i, a, w, o, m) {
            var z = this, u, v = {}, j = {}, n = [], f, d, s, q = a.$ChessMode.$Column || 0, r = a.$ChessMode.$Row || 0, g = a.We(o, m), p = C(a), D = p.length - 1, t = a.$Duration + a.$Delay * D, x = w + t, l = a.$SlideOut, y;
            x += 50;
            ...
            b.rb(i, h);
            if (b.fc()) {
                var E = !i["no-image"], A = b.ig(i);
                b.$Each(A, function(a) { (E || a["jssor-slider"]) && b.Db(a, b.Db(a), e) })
            }
            b.$Each(p, function(h, i) {
                b.$Each(h, function(G) {
                    ...
                    if (a.x) d.L += o * a.x * L;
                    if (a.y) d.J += m * a.y * M;
                    b.$Each(d, function(a, c) { if (b.Xb(a)) if (a != f[c]) s[c] = a - f[c] });
                    v[t] = l ? f : d;
                    var D = a.Xe, y = c.round(i * a.$Delay / a.$Interval);
                    j[t] = new Array(y);
                    j[t].Ce = y;
                    j[t].ye = y + D - 1;
                    for (var F = 0; F <= D; F++) {
                        var E = b.fe(f, s, F / D, a.$Easing, a.$During, a.$Round, { $Move: a.$Move, $OriginalWidth: o, $OriginalHeight: m });
                        E.$ZIndex = E.$ZIndex || 1;
                        j[t].push(E)
                    }
                })
    ...
    var j = i.$JssorSlider$ = function(q, hc) {
        ...
        function Dc() {
            ...
            l.call(a, -1, 2, { $Easing: d.$Linear, Qe: { Bb: bc }, Ac: r }, b, { Bb: 1 }, { Bb: -2 });
            a.cc = b
        }
        ...
        function Bc(i, f) {
            var d = this, q, M, x, n, y = [], w, B, W, H, S, F, g, v, p;
            l.call(d, -u, u + 1, {});
            ...
            function G(e, i, l) {
                if (e == f) {
                    ...
                    var k = c.min(f, e), j = c.max(f, e), o = c.min(j - k, k + r - j), n = u + a.$LazyLoading - 1;
                    (!S || o <= n) && d.zb()
                }
            }
            ...
            function Z(a) { !N && o.l(j.$EVT_CLICK, f, a) }
        ...
        function zc(y, f, p, q) {
            ...
            a.hg = function() { d == c && d == a.yb() && a.H(h) };
            a.qf = function() {
                A && A.nb == f && A.Cb();
                var b = a.yb();
                b < c && o.l(j.$EVT_STATE_CHANGE, f, -b - 1, m, h, d, c)
            };
            a.dd = function(a) { p && b.mb(ib, a && p.Kc.$Outside ? "" : "hidden") };
            a.Nc = function(b, a) {
                if (i && a >= g) {
                    i = k;
                    v();
        ...
        function Ib(a) { !b.$AttributeEx(b.$EvtSrc(a), "nodrag") && b.$CancelEvent(a) }
        ...
        function Wb(a, c) {
            yb = a;
            b.$Each(S, function(b) { b.Gc(t(a), a, c) })
        }
        ...
        function zb() { b.$Each(S, function(a) { a.Mc(a.Qb.$ChanceToShow <= F) }) }
        ...
        o.$PlayTo = ob;
        o.$GoTo = function(a) { w.H(Lb(a)) };
        o.$Next = function() { mb(1) };
        o.$Prev = function() { mb(-1) };
        o.$Pause = function() { L = k };
        o.$Play = function() {
            if (!L) {
                L = e;
                C[s] && C[s].Cc()
        ...
        o.$SetSlideshowTransitions = function(b) { a.$SlideshowOptions.$Transitions = b };
        o.$SetCaptionTransitions = function(a) {
            I.$Transitions = a;
            I.yc = b.P()
        };
        o.$SlidesCount = function() { return T.length };
        o.$CurrentIndex = function() { return s };
        o.$IsAutoPlaying = function() { return L };
        o.$IsDragging = function() { return B };
        o.$IsSliding = function() { return P };
        o.$IsMouseOver = function() { return !F };
        o.$LastDragSucceded = function() { return N };

        function X() { return b.$CssWidth(y || q) }
        ...
        var hb = a.$PlayOrientation & 3, xc = (a.$PlayOrientation & 4) / -4 || 1, eb = a.$SlideshowOptions, I = b.p({ $Class: p, $PlayInMode: 1, $PlayOutMode: 1, $HWA: a.$HWA }, a.$CaptionSliderOptions);
        I.$Transitions = I.$Transitions || I.$CaptionTransitions;
        var rb = a.$BulletNavigatorOptions, W = a.$ArrowNavigatorOptions, ab = a.$ThumbnailNavigatorOptions, Q = !a.$UISearchMode, y, v = b.$FindChild(q, "slides", Q), cb = b.$FindChild(q, "loading", Q) || b.$CreateDiv(g), Jb = b.$FindChild(q, "navigator", Q), ec = b.$FindChild(q, "arrowleft", Q), cc = b.$FindChild(q, "arrowright", Q), Hb = b.$FindChild(q, "thumbnavigator", Q), pc = b.$CssWidth(v), oc = b.$CssHeight(v), V, T = [], yc = b.$Children(v);
        b.$Each(yc, function(a) {
            a.tagName == "DIV" && !b.$AttributeEx(a, "u") && T.push(a);
            b.D(a, (b.D(a) || 0) + 1)
        });
        var s = -1, yb, ub, r = T.length, K = a.$SlideWidth || pc, J = a.$SlideHeight || oc, Yb = a.$SlideSpacing, Bb = K + Yb, Cb = J + Yb, dc = hb & 1 ? Bb : Cb, u = c.min(a.$Cols, r), ib, x, M, Ab, S = [], Sb, Ub, Qb, fc, Gc, L, E = a.$PauseOnHover, qc = a.$AutoPlayInterval, Xb = a.$SlideDuration, sb, db, gb, Tb = u < r, D = Tb ? a.$Loop : 0, Y, N, F = 1, P, B, R, vb = 0, wb = 0, H, bb, fb, Eb, w, U, z, Vb = new sc, Z, Nb = [];
        if (r) {
            if (a.$HWA) Mb = function(a, c, d) { b.rb(a, { $TranslateX: c, $TranslateY: d }) };
            L = a.$AutoPlay;
            o.Qb = hc;
            lc();
            ...
            var xb = v, C = [], A, O, Fb = b.$Device(), kb = Fb.gf, G, qb, Kb, tb;
    ...
    i.$JssorBulletNavigator$ = function(d, C) {
        ...
        f.Qb = a = b.p({ $SpacingX: 10, $SpacingY: 10, $Orientation: 1, $ActionMode: 1 }, C);
        ...
        function A(o, f) {
            ...
            function j(e) {
                if (e || !s.$LastDragSucceded()) {
                    var a = d - f % d, b = s.Sd((f + a) / d - 1), c = b * d + d - a;
                    i.l(n.gc, c)
                }
            }
        ...
        i.Dc = function(F, D) {
            if (!w) {
                ...
                b.$Each(D, function(l, g) {
                    var j = new A(l, g), e = j.cc, a = c.floor(g / d), k = g % d;
                    b.B(e, (u + q) * k * (1 - h));
                    b.C(e, (t + r) * k * h);
                    if (!i[a]) {
                        i[a] = b.$CreateDiv();
                ...
                var E = b.p({ $AutoPlay: k, $NaviQuitDrag: k, $SlideWidth: m, $SlideHeight: l, $SlideSpacing: q * h + r * (1 - h), $MinDragOffsetToSlide: 12, $SlideDuration: 200, $PauseOnHover: 1, $PlayOrientation: a.$Orientation, $DragOrientation: a.$NoDrag || a.$DisableDrag ? 0 : a.$Orientation }, a);
                s = new j(g, E);
                w = e
            }
        };
        i.Qb = a = b.p({ $SpacingX: 0, $SpacingY: 0, $Cols: 1, $Orientation: 1, $AutoCenter: 3, $ActionMode: 1 }, B);
        z = b.$CssWidth(g);
        x = b.$CssHeight(g);
    ...
    i.$JssorCaptionSlideo$ = function(v, j, u, E) {
        ...
        function t(e, c) {
            ...
            b.$Each(d, function(d) {
                ...
                if (h) {
                    var e = b.$AttributeEx(d, "t"), g = p[b.Rb(e)] || p[e], f = { $Elmt: d, Kc: g };
                    a.push(f)
                }
        ...
        function z(t, u, g) {
            ...
            b.$Each(u, function(i) {
                var h = b.p(e, {}, r(i)), j = b.uc(h.$Easing);
                delete h.$Easing;
                if (h.$Left) {
                    h.L = h.$Left;
                    j.L = j.$Left;
                ...
                var o = { $Easing: j, $OriginalWidth: g.S, $OriginalHeight: g.R }, k = new l(i.b, i.d, o, t, g, h);
                f = c.max(f, i.b + i.d);
                if (a)
                    if (d) d.O(k);
                    else d = k;
            ...
            if (a && d) {
                var i = d, k, j = d.Nb(), p = d.tb(), q = c.max(p, a.Bf);
                if (a.eb < p) {
                    if (a.eb > j) {
                        i = new l(j, a.eb - j);
                        i.O(d, e)
                    } else i = h;
                    k = new l(a.eb, q - j, { Ac: q - a.eb, Oe: e });
                    k.O(d, e)
                }
                i && a.Oc.push(i);
                k && a.Sc.push(k)
        ...
        function y(a) {
            b.$Each(a, function(f) {
                var a = f.$Elmt, e = b.$CssWidth(a), d = b.$CssHeight(a), c = { $Left: b.B(a), $Top: b.C(a), L: 0, J: 0, $Opacity: 1, $ZIndex: b.D(a) || 0, $Rotate: 0, $RotateX: 0, $RotateY: 0, $ScaleX: 1, $ScaleY: 1, $TranslateX: 0, $TranslateY: 0, $TranslateZ: 0, $SkewX: 0, $SkewY: 0, S: e, R: d, $Clip: { $Top: 0, $Right: e, $Bottom: d, $Left: 0 } };
                c.he = c.$Left;
                c.ve = c.$Top;
                z(a, f.Kc, c)
            })
        ...
        function i(k, d, e) {
            ...
            if (g > 4)
                for (var m = c.ceil(g / 4), a = 0; a < m; a++) {
                    var h = d.slice(a * 4, c.min(a * 4 + 4, g)), j = new l(h[0].eb, 0);
                    i(j, h, e);
                    k.O(j)
                }
            else
        ...
        y(t(v, 1));
        i(m, g);
        var x = j.$Breaks || [], k = [].concat(x[b.Rb(b.$AttributeEx(v, "b"))] || []);
