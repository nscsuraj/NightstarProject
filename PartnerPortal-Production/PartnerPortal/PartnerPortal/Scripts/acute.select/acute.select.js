...
.factory('acuteSelectService', function() {
    ...
    return {
        getSettings: function() {
            ...
            defaultSettings.templatePath = root + "scripts" + defaultSettings.templatePath;
            defaultSettings.loadOnOpen = true;
            defaultSettings.loadOnCreate = false;
            defaultSettings.minWidth = '100%';
          //  alert(defaultSettings.templatePath);
