...
var app = angular.module('app', ['ui.bootstrap', 'ui', 'ui.tree', 'oitozero.ngSweetAlert', 'ivh.treeview', 'angularUtils.directives.dirPagination', 'akFileUploader', 'acute.select', 'ngJsonExportExcel', 'angularjs-dropdown-multiselect']);
