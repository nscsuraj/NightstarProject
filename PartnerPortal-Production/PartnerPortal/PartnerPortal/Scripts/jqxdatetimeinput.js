...
//Don't update this file......Becouse some update by Amit Mandal (Line 3924)
//Don't update this file......Becouse update Tab off(Line 4161)
        ...
        _handleKeyPress: function (k, o) {
            ...
            if (n.start >= 0) {
                ...
                if (!isNaN(l)) {
                    ...
                    ////Update Start by Amit Mandal
                    //var output = "00";
                    //switch (this.activeEditor.item.type) {
                    //    case "Month":
                    //        {
                    //            output = "12";
                    //            if (this.activeEditor.value == 1) {
                    //                if (f == 0 || f == 1 || f == 2) {
                    //                    output = this.activeEditor.value + f;                                        
                    //                }

                    //            } else {
                    //                output = f;
                    //            }
                    //            this.activeEditor.value = output;
                    //            if (output > 1) {
                    //                this._doRightKey();
                    //            }
                    //            break;
                    ...
                    //        {
                    //            output = "30";
                    //            if (this.activeEditor.value < 3) {
                    //                output = this.activeEditor.value + f;
                    //            }
                    //            else if (this.activeEditor.value == 3) {
                    //                if (f == 1) {
                    //                    output = this.activeEditor.value + f;
                    //                }
                    //            } else {
                    ...
                    //        {
                    //            output = "2000";
                    //            if (this.activeEditor.value < 999) {
                    //                output = this.activeEditor.value + f;
                    //            }
                    //            else {
                    //                output = f;
